...
| Per-screen micro-polish spec in the bet's `technical-design.md` Surface Design (motion / atmosphere / static-micro, token-traceable) | bet 02-design Step 1.95 (designer persona); concreteness-gated at Step 2.5 | 04-delivery Tier 2 spec-conformance inspection; 05-validation |
