...
- `docs/PORTABLE.md` — current authoring guide; `docs/WORKSPACES.md` — proposed repository, product, catalog and workspace model with its execution plan; `docs/CONTENT.md` — legacy import format; `docs/history/` — superseded design and evaluation notes; `docs/reviews/` — dated code-review reports.
