...
All lifecycle phases share a single set of behavioral protocols defined in `operating-contract.md` (source: `src/hidden-skills/operating-contract.md`; installed into user projects at `.groundwork/skills/operating-contract.md`) and loaded by every methodology skill:
