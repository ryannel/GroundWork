...
**Status:** PROPOSED 2026-08-13 — nothing executed. Derived from two subagent review suites run the same day: a six-lens onboarding review of the brownfield flow (14 agents, 40 findings, top 8 adversarially verified: 4 confirmed / 4 partial / 0 refuted) and a six-lens red-team of the resulting doc-cut proposals (14 agents, 55 findings, top 8 verified: 3 confirmed / 5 partial / 0 refuted). Full reports: [onboarding review](https://claude.ai/code/artifact/ed972628-924b-4c4e-b672-11c1d6c9b49a), [doc-diet red-team](https://claude.ai/code/artifact/dab24136-9fa0-49f6-974b-0cbdbd3a9e30).
