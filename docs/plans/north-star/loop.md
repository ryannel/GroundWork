...
7. A fresh-context subagent writes the capsule, handed the facts it needs — the diff, the proof plan, the findings — so it renders them into plain prose and never goes researching. The slice enters the Queue unless a prior seal covers it.
