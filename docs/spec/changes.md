...
This document is the decision artifact. The execution plan itself lives in [the execution plan](../execution-plan.md). Its delivery approach is already settled; its ladder firms up at ratification.
