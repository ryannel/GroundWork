...
for (const [name, schema] of Object.entries({ 'discovery-assessment': discoveryAssessmentSchema, 'scan-manifest': scanManifestSchema, 'knowledge-baseline': knowledgeBaselineSchema, 'portable-project': manifestSchema, 'portable-product': portableProductSchema, delivery: deliverySchema, ...operationSchemas })) {
