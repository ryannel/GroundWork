...
**User-visible goal:** [what a user can demonstrably do or observe when this milestone is complete — named in the product's interface medium]

**Why this comes first:** [sequencing rationale — what architectural proof this provides, why value is delivered even if later milestones never ship]

**Acceptance criteria:**
- [ ] [specific, falsifiable criterion — e.g. "the command returns exit 0 and prints the confirmation message"]
...
**User-visible goal:** [what a user can demonstrably do or observe]

**Why this comes after Milestone 1:** [sequencing rationale — what Milestone 1 must have proven before this work begins]
...
*(Add a Slice section for each slice under Milestone 2. Repeat the Milestone block for every milestone in this bet — 2–5 milestones is the healthy range.)*
