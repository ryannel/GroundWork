...
const feature: Feature = { id: 'tax', productId: 'pricing', title: 'Tax rules', stage: 'building', ownerId: 'ryan', owner: 'Ryan', updatedAt: '2026-09-05', touches: ['pricing-api', 'cart-api', 'cart-db', 'missing'] }
