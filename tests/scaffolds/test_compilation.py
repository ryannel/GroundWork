...
@pytest.mark.xfail(
    reason="docs-site tsc --noEmit fails on '@/.source' because that module is a "
           "Fumadocs build artifact generated by `next build`; the template is correct "
           "but the type is only available after a full build step.",
    strict=False,
)
