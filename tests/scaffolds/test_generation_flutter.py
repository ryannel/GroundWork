...
def test_engineer_skill_provenance_recorded(default_app):
    ...
    hash — promoteEngineerSkill runs inside the flutter-app generator before
    ...
    gen = manifest["generated"]["flutter-app:mobile-app"]
    skill_files = [f for f in gen["files"] if f.startswith(".agents/skills/groundwork-flutter-engineer/")]
