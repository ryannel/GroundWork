...
| 5. Validation | `workflows/05-validation.md` | `validation` → `delivered` | Canonical `docs/api/` captured from running code; retrospective; whole bet archived |
