...
| `03-api-design.md` | **API Design** — the interface contracts (purpose, error guidance, rationale), surface-neutral. | `technical-design/03-api-design.md` |
| `04-data-design.md` | **Schema & Data Design** — the data model: stores, key fields, lifecycle states, and modelling rationale. | `technical-design/04-data-design.md` |
