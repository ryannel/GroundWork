...
The registry and ledger contract lives at `.agents/groundwork/skills/templates/surfaces.md`. Read it before touching either artifact — `docs/surfaces.md` and `.groundwork/surfaces.json` are projections of the same decisions, written together in every change this skill makes.
