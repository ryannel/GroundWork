...
- **Component idiom, composition, and visual language** → `groundwork-nextjs-engineer/references/visual-language.md` and `references/ux-principles.md`. Skip the App Router / Server Component material — an Electron renderer is fully client-side and has no server boundary.
...
- **Accessibility** → `groundwork-nextjs-engineer/references/ux-principles.md` (Accessibility) and `references/testing.md` (Accessibility Testing). Desktop changes nothing about it.
