...
/** Observation kinds a component catalog records (retired, renamed or cited as finding subjects). */
export const observationKindSchema = z.enum(['endpoint', 'schema', 'data', 'message', 'job', 'flow'])
