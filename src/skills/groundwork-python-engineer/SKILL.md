...
| FastAPI endpoint, route handler, request/response mapping | `architecture.md`, `documentation-mcp.md` |
...
| Dependency injection, Protocol ports, wiring | `implementation-patterns.md`, `architecture.md` |
