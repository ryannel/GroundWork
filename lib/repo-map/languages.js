...
//
// Each entry binds a tree-sitter grammar (shipped as wasm by `tree-sitter-wasms`,
// or supplied by the project — see "Project extension seam" below) to the queries
...
// Where the bundled tree-sitter grammars live (tree-sitter-wasms/out/*.wasm).
...
const BUILTIN = [
  ...
  },
  {
    ...
    fidelity: 'symbols',
    importQuery: '(import_header (identifier) @imp)',
    symbolQuery: `[
      (class_declaration (type_identifier) @sym)
      (function_declaration (simple_identifier) @sym)
      (object_declaration (type_identifier) @sym)
    ]`,
  },
  {
    id: 'csharp',
  ...
  },
  {
    ...
    fidelity: 'symbols',
    importQuery: '(import_declaration path: (_) @imp)',
    symbolQuery: `[
      (class_definition name: (identifier) @sym)
  ...
  },
  {
    ...
    fidelity: 'symbols',
    symbolQuery: `[
      (function_definition_statement name: (identifier) @sym)
      (local_function_definition_statement name: (identifier) @sym)
    ]`,
  },
];
...
const NUDGE = {
  '.dart': {
    lang: 'Dart',
    reason: 'the bundled grammar targets a newer tree-sitter ABI than the engine supports',
  },
  '.elm': { lang: 'Elm', reason: 'the bundled grammar targets an older tree-sitter ABI' },
